...
import { useGetNewsByBlogQuery, useGetNewsByPoliticsQuery } from "../../features/newsApiSlice";
...
const PoliticsPage = () => {
  ...
  const {
    ...
    error: newsListError,
  } = useGetNewsByBlogQuery({ keyword: "", pageNumber });
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <div className="py-8 md:px-8 px-1">
        ...
        <Pagination page={newsList.page} pages={newsList.pages} state='blog' />
      </div>
