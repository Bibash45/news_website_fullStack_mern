...
import { useDeleteNewsMutation, useGetNewsByNepaliBrandQuery } from "../../../features/newsApiSlice";
...
const NepaliBrandNews = () => {
  ...
  } = useGetNewsByNepaliBrandQuery({ keyword, pageNumber });
              ...
              >
                ...
                <div className="text-end w-full flex flex-wrap justify-around items-center">
                  ...
                  <div className="w-1/4 flex justify-end items-center">
                    ...
                    className="text-red-500  px-3 py-2 rounded-md cursor-pointer w-full text-end flex justify-end">
                      <MdDelete size={25} />
                    </button>
                  </div>
                </div>
...
export default NepaliBrandNews;
