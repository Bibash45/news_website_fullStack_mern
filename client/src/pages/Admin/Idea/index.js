...
import { useDeleteNewsMutation, useGetNewsByIdeaQuery } from "../../../features/newsApiSlice";
...
const IdeaNews = () => {
  ...
  } = useGetNewsByIdeaQuery({ keyword, pageNumber });
            ...
            newsList.data.map((news, index) => (
              ...
              >
                ...
                <div className="text-end w-full flex flex-wrap justify-around items-center">
                  ...
                  <div className="w-1/4 flex justify-end items-center">
                    <button className="text-red-500  px-3 py-2 rounded-md cursor-pointer w-full text-end flex justify-end">
                      <MdDelete size={25} />
                    </button>
                  </div>
                </div>
